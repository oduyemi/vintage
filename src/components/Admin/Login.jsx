    ...
    return (
        <Box margin="10px" className="h-screen mx-auto border rounded-md shadow">
            <form className="max-w-sm mx-auto w-full" onSubmit="">
                <h1 className='text-center text-3xl text-dark hover:text-greene font-extrabold pt-10 pb-10'>Login Form</h1>
                    {/* {flashMessage && (
                ...
                <Box className="text-white text-center my-3">
                    <span style={{ fontSize: "smaller"}}>Not an admin? &nbsp;
                        <Link className="" to="/" style={{ textDecoration: "none", color:"red" }}>Click Here</Link>
                    </span>
                </Box>
            </form>
        </Box>
